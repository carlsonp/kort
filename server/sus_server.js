    ...
    results: function (req, res, next) {
        Study.findOne({_id: req.params.id, ownerID: req.user._id}, function (err, study) {
            if (err) {
                ...
                var raw_percentile_ranks = [[5,0.3],[10,0.4],[15,0.7],[20,1.0],[25,1.5],[30,2],[35,4],[40,6],[45,8],[50,13],[55,17],[60,29],[65,41],[66,44],[67,47],[68,50],[69,53],[70,56],[71,60],[72,63],[73,67],[74,70],[75,73],[76,77],[77,80],[78,83],[79,86],[80,88],[85,97],[90,99.80],[95,99.9999],[100,100]];
